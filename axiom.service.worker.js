...
/** @type {string} */
const CACHE_VERSION = '1787354550|1162083316';
/** @type {string} */
const CACHE_PREFIX = 'axiom-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'axiom.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["axiom.html","axiom.js","axiom.offline.html","axiom.icon.png","axiom.apple-touch-icon.png","axiom.audio.worklet.js","axiom.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["axiom.wasm","axiom.pck"];
